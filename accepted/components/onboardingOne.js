  ...
  React.useEffect(async () => {
    ...
    return (
        <div className = 'm-auto w-4/5 mt-4'>
            ...
            <button className = 'bg-blue-600 text-white rounded mt-4 w-28 p-1'>
                    Next
            </button>

            <Link href="">
                <p className = 'm-auto text-xs mt-2 justify-center'><a className = "text-blue-600">Skip for now</a></p>
            </Link>
